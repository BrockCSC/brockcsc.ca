/* The image frame shown in the hero in the homepage */
...
export function PhotoFrame({ className, children }: PhotoFrameProps) {
  return (
    <div className={cn("relative w-full h-full", className)}>
      <div className="absolute inset-0 rounded-[32px] border-2 border-black bg-white rotate-2 shadow-neo z-10 transition-transform hover:rotate-1 duration-500 overflow-hidden group">
